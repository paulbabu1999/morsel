...
_SYSTEM = (
    ...
    "\n"
    "PORTION SIZE is the biggest source of error — anchor it to visible references: "
    "a standard dinner plate is ~26cm, a fork ~19cm, a hand/thumb for scale. Judge "
    "depth and fullness, not just area. Account for calorie-dense extras that are "
    "easy to miss: cooking oil/ghee/butter a dish was fried or sauteed in, dressings, "
    "sauces, and cheese. Lower `confidence` when the portion is genuinely ambiguous.\n"
    "\n"
